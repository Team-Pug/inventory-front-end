...
var accountEvents = __webpack_require__(11);
var productEvents = __webpack_require__(14);
var ux = __webpack_require__(3);
...
var userUi = __webpack_require__(13);
...
var onCreateAccount = function onCreateAccount(event) {
  ...
  if (data.credentials.password !== data.credentials.password_confirmation) {
    ...
    userApi.create(data).then(userUi.onCreateSuccess).catch(userUi.onError);
  }
};
...
var onChangePassword = function onChangePassword(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  userApi.changePassword(data).then(userUi.onChangePasswordSuccess).catch(userUi.onChangePasswordError);
};

var onSignOut = function onSignOut(event) {
  event.preventDefault();
  userApi.signOut().then(userUi.onSignOutSuccess).catch(userUi.onSignOutError);
};
module.exports = {
...
var onSignInError = function onSignInError(response) {
  $('.user-messages').children().hide();
  $('#sign-in-error').show();
};
...
var onChangePasswordError = function onChangePasswordError(response) {
...
var productApi = __webpack_require__(15);
var productUi = __webpack_require__(16);
var getFormFields = __webpack_require__(4);
...
var onCreateProduct = function onCreateProduct(event) {
  ...
  productApi.createProduct(data).then(productUi.onCreateProductSuccess).then(onGetAllProducts(event)).catch(productUi.onCreateProductError);
};

// is 'const data' necessary for functionality?
var onGetAllProducts = function onGetAllProducts(event) {
  event.preventDefault();
  productApi.getAllProducts().then(productUi.onGetAllProductsSuccess).catch(productUi.onGetAllProductsError);
};

var onGetProduct = function onGetProduct(event) {
  event.preventDefault();
  var id = $(this).data('id');
  productApi.getProduct(id).then(productUi.onGetProductSuccess).catch(productUi.onGetProductError);
};
...
var onUpdateProduct = function onUpdateProduct(event) {
  ...
  var id = $(this).data('id');
  var data = getFormFields(event.target);
  productApi.updateProduct(data, id).then(productUi.onUpdateProductSuccess).then(onGetAllProducts(event)).catch(productUi.onUpdateProductError);
};

var onDeleteProduct = function onDeleteProduct(event) {
  event.preventDefault();
  var id = $(this).data('id');
  productApi.deleteProduct(id).then(productUi.onDeleteProductSuccess).catch(productUi.onDeleteProductError);
};
...
var onCreateProductSuccess = function onCreateProductSuccess() {
  $('#create-product')[0].reset();
};

var onCreateproductError = function onCreateproductError(response) {};

var onUpdateProductSuccess = function onUpdateProductSuccess() {
  $('.update-product-form')[0].reset();
};

var onUpdateProductError = function onUpdateProductError() {};

var onGetAllProductsSuccess = function onGetAllProductsSuccess(data) {
  $('#table-holder').empty();
  $(function () {
    var theTemplateScript = $('#product-inventory-template').html();
...
var onGetAllProductsError = function onGetAllProductsError(response) {};

var onDeleteProductSuccess = function onDeleteProductSuccess(data) {
  $('.' + data.product.id).remove();
};

var onDeleteProductError = function onDeleteProductError() {
  $('#myModal').modal('show');
};

var onGetProductSuccess = function onGetProductSuccess(data) {
  $('#table-holder').empty();
  $(function () {
    var theTemplateScript = $('#product-show-template').html();
    // Compile the template
    var theTemplate = Handlebars.compile(theTemplateScript);
    // Define our data object
    var context = data.product;
    // Pass our data to the template
    var theCompiledHtml = theTemplate(context);
    // Add the compiled html to the page
    $('#table-holder').prepend(theCompiledHtml);
...
var onGetProductError = function onGetProductError() {};

module.exports = {
  onCreateProductSuccess: onCreateProductSuccess,
  onCreateproductError: onCreateproductError,
  onUpdateProductSuccess: onUpdateProductSuccess,
  onUpdateProductError: onUpdateProductError,
  onGetAllProductsSuccess: onGetAllProductsSuccess,
  onGetAllProductsError: onGetAllProductsError,
  onDeleteProductSuccess: onDeleteProductSuccess,
  onDeleteProductError: onDeleteProductError,
  onGetProductSuccess: onGetProductSuccess,
  onGetProductError: onGetProductError
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
